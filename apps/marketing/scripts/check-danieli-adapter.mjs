...
const oldProtectedHtmlPath = resolve(
  marketingRoot,
...
const publicProtectedHtmlPath = resolve(
  marketingRoot,
  'public/danieli-md1-ontology-and-kcards_7_1-v0.html'
)
...
assert.equal(existsSync(oldProtectedHtmlPath), false, 'old 6_25 protected HTML should not be shipped')
