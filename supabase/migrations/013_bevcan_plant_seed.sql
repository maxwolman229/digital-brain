-- =============================================================================
-- 013_bevcan_plant_seed.sql
-- Creates the public BevCan 1.0 knowledge bank plant with 20 reference rules
-- covering the key process areas of beverage can manufacturing.
--
-- Plant UUID: dddddddd-dddd-dddd-dddd-dddddddddddd
-- Org UUID:   aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa  (MD1 Public)
-- =============================================================================
...
-- ── Reference Rules ───────────────────────────────────────────────────────────
-- 20 reference rules seeded by MD1 Team. Status = 'Reference'.
-- These represent established industry knowledge for the community to react to.
-- IDs use BC- prefix to avoid PK conflicts with demo plant rules (R-001 etc).
